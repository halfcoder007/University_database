    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="home.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home<span class="sr-only">(current)</span></a></li>
        ...
        <li><a href="coming.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Video Tutorials</a></li>
         <li  class="active"><a href="trailer.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Trailers</a></li>
...
<div class="col-md-9 mvlst1">
  ...
  <div class="col-md-6"> <iframe width="410" height="250" src="https://www.youtube.com/embed/JAUoeqvedMo" frameborder="0" allowfullscreen></iframe></div>      
  <div class="col-md-6"> <iframe width="410" height="250" src="https://www.youtube.com/embed/pXwaKB7YOjw" frameborder="0" allowfullscreen></iframe></div>
  <div class="col-md-6"> <iframe width="410" height="250" src="https://www.youtube.com/embed/AFCdylObHW4" frameborder="0" allowfullscreen></iframe>
  </div>
  <div class="col-md-6"> <iframe width="410" height="250" src="https://www.youtube.com/embed/eisKxhjBnZ0" frameborder="0" allowfullscreen></iframe></div>
  </div>
 </div>
