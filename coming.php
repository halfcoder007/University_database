...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="css/bootstrapcoming.min.css" rel="stylesheet">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="home.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home<span class="sr-only">(current)</span></a></li>
        ...
        <li class="active"><a href="coming.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Video Tutorials</a></li>
...
<div class="col-md-9 mvlst1">
            <div class="col-lg-12">
               <h1 class="page-header"></h1>
            </div>
        
  <div class="col-md-6"> <iframe width="410" height="250" src="https://www.youtube.com/embed/XfwZcYxwxZ4?list=PLRdux5uhMFiepKgD56YNFlNvz2j3YRlqr" frameborder="0" allowfullscreen></iframe></div>      
  <div class="col-md-6"> <iframe width="410" height="250" src="https://www.youtube.com/embed/Hl-zzrqQoSE?list=PL1B31351B1D7F6250" frameborder="0" allowfullscreen></iframe></div>
  <div class="col-md-6"> <iframe width="410" height="250" src="https://www.youtube.com/embed/NSQQ9ZchtzE" frameborder="0" allowfullscreen></iframe>
  </div>
  <div class="col-md-6"> <iframe width="410" height="250" src="https://www.youtube.com/embed/D48iCw3WWpI" frameborder="0" allowfullscreen></iframe></div>
  </div>
 </div>
